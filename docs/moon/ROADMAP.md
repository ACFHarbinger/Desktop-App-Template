...
This document tracks planned scaffolding work for `Desktop-App-Repo` itself. Once this template seeds a real project, replace this file's contents with that project's actual roadmap — per-module detail then lives in `docs/moon/roadmaps/<module>.md`. Completed items move to [`docs/moon/CHANGELOG.md`](CHANGELOG.md).
